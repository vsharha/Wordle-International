...
function RestartButton() {
  ...
  return (
    <div className={twMerge("backdrop-blur-xs absolute bottom-0 w-full h-[110%] flex justify-center items-center", visible?"animate-fade-in":"")} onAnimationEnd={onFadeInEnd} onClick={(e)=>e.stopPropagation()}>
